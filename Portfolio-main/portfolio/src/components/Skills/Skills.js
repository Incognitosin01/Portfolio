		...
		<section id="skills" className={styles.container}>
			...
			<div className={styles.codingProfileDiv}>
				<div className={styles.title}>
					Leetcode Profile :{" "}
					<a
						href="https://leetcode.com/incognitosin007/"
				...
				<div className={styles.questionSolved}>
					...
					<span style={{ color: "cyan" }}>{data?.totalSolved}</span>
				</div>
				<div className={styles.progressContainer}>
					...
					<div className={styles.progress}>
						...
						>
							<div>
								<span style={{ color: "cyan" }} className={styles.ques}>
									{data?.mediumSolved}
								</span>
								/{data?.totalMedium}
							</div>
						</CircularProgressbarWithChildren>
						<p style={{ color: "cyan" }} className={styles.quesType}>
							Medium
						</p>
					</div>
					<div className={styles.progress}>
